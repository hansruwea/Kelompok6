...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-primary elevation-4">
    ...
    <a href="{{route('admin')}}" class="brand-link">
      <img src="{{ asset('img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">JOGJATRONIK</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022 <a href="https://www.yogyes.com/id/places/jogja/jogjatronik-mall/">JOGJATRONIK</a>.</strong> Project UAS E-commerce.
  </footer>
</div>
<!-- ./wrapper -->
