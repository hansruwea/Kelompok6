    ...
    <div class="col">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Merk Elektronik</h4>
          <div class="card-tools">
            <a href="{{ route('kategori.create') }}" class="btn btn-sm btn-dark">
              Tambah Baru
            </a>
          </div>
        </div>
              ...
              @foreach($itemkategori as $kategori)
                <tr>
                  ...
                  <td>
                    ...
                    width='150px' class="img-thumbnail mb-1">
                    <br>
                  ...
                  <td>
                    <a href="{{ route('kategori.edit', $kategori->id) }}" class="btn btn-sm btn-success mr-2 mb-2">
                      Edit
                    </a>
