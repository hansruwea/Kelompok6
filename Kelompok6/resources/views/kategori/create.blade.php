    ...
    <div class="col col-lg-6 col-md-6">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Form Merk Elektronik</h3>
        ...
        <div class="card-body">
          ...
          @csrf
            ...
            <div class="form-group">
              <label for="nama_kategori">Merk Elektronik</label>
              <input type="text" name="nama_kategori" id="nama_kategori" class="form-control">
            </div>
            <div class="form-group">
              <label for="slug_kategori">Diskon Penjualan</label>
              <input type="text" name="slug_kategori" id="slug_kategori" class="form-control">
            </div>
            <div class="form-group">
              <label for="deskripsi_kategori">Deskripsi Spesifikasi</label>
